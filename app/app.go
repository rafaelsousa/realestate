...
var (
	...
	maccPerms = map[string][]string{
		...
		realestatemoduletypes.ModuleName: {authtypes.Minter, authtypes.Burner},
...
func New(
	...
	app.RealestateKeeper = *realestatemodulekeeper.NewKeeper(
		appCodec,
		keys[realestatemoduletypes.StoreKey],
		keys[realestatemoduletypes.MemStoreKey],
		app.GetSubspace(realestatemoduletypes.ModuleName),
		app.BankKeeper,
	)
