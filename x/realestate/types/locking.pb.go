...
func (m *Locking) GetAssets() uint64 {
	if m != nil {
		return m.Assets
	}
	return 0
...
var fileDescriptor_dc6bd36b084d77fa = []byte{
	...
	,
}
...
func (m *Locking) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Assets != 0 {
		i = encodeVarintLocking(dAtA, i, uint64(m.Assets))
		i--
		dAtA[i] = 0x28
	}
...
func (m *Locking) Size() (n int) {
	...
	if m.Assets != 0 {
		n += 1 + sovLocking(uint64(m.Assets))
	}
	if m.Property != 0 {
