...
func NewMsgCreateHouse(creator string, description string, image string, blueprint string) *MsgCreateHouse {
...
func NewMsgUpdateHouse(creator string, id uint64, description string, image string, blueprint string) *MsgUpdateHouse {
