...
func NewMsgCreateProperty(creator string, address string, city string, state string, zip string, country string, latitude string, longitude string, owner string) *MsgCreateProperty {
...
func NewMsgUpdateProperty(creator string, id uint64, address string, city string, state string, zip string, country string, latitude string, longitude string, owner string) *MsgUpdateProperty {
