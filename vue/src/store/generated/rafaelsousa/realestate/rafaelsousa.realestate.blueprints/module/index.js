...
const txClient = async (wallet, { addr: addr } = { addr: 'http://localhost:26657' }) => {
  ...
  return {
    ...
    msgCreateHouse: (data) => ({
      typeUrl: '/rafaelsousa.realestate.blueprints.MsgCreateHouse',
      value: MsgCreateHouse.fromPartial(data),
    }),
    msgUpdateHouse: (data) => ({
      typeUrl: '/rafaelsousa.realestate.blueprints.MsgUpdateHouse',
      value: MsgUpdateHouse.fromPartial(data),
    }),
    msgDeleteHouse: (data) => ({
      typeUrl: '/rafaelsousa.realestate.blueprints.MsgDeleteHouse',
      value: MsgDeleteHouse.fromPartial(data),
    }),
  }
}
