...
const baseQueryGetHouseRequest = { id: 0 };
export const QueryGetHouseRequest = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseQueryGetHouseRequest };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseQueryGetHouseResponse = {};
export const QueryGetHouseResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseQueryGetHouseResponse };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseQueryAllHouseRequest = {};
export const QueryAllHouseRequest = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseQueryAllHouseRequest };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseQueryAllHouseResponse = {};
export const QueryAllHouseResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseQueryAllHouseResponse };
        message.House = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
...
export class QueryClientImpl {
    ...
    Params(request) {
        ...
        const promise = this.rpc.request("rafaelsousa.realestate.blueprints.Query", "Params", data);
        return promise.then((data) => QueryParamsResponse.decode(new Reader(data)));
    }
    House(request) {
        const data = QueryGetHouseRequest.encode(request).finish();
        const promise = this.rpc.request("rafaelsousa.realestate.blueprints.Query", "House", data);
        return promise.then((data) => QueryGetHouseResponse.decode(new Reader(data)));
    }
    HouseAll(request) {
        const data = QueryAllHouseRequest.encode(request).finish();
        const promise = this.rpc.request("rafaelsousa.realestate.blueprints.Query", "HouseAll", data);
        return promise.then((data) => QueryAllHouseResponse.decode(new Reader(data)));
    }
}
var globalThis = (() => {
