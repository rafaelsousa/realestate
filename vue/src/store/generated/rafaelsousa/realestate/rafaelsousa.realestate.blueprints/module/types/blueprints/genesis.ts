...
/** GenesisState defines the blueprints module's genesis state. */
...
const baseGenesisState: object = { houseCount: 0 };
...
export const GenesisState = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.houseCount = longToNumber(reader.uint64() as Long);
          break;
        default:
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.houseList) {
      obj.houseList = message.houseList.map((e) =>
        e ? House.toJSON(e) : undefined
      );
    } else {
      obj.houseList = [];
    }
