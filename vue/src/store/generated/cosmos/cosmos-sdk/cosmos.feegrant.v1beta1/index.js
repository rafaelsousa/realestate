...
import { AllowedMsgAllowance, BasicAllowance, Grant, PeriodicAllowance, } from './module/types/cosmos/feegrant/v1beta1/feegrant';
...
export default {
    ...
    actions: {
        ...
        async QueryAllowance({ commit, rootGetters, getters }, { options: { subscribe, all } = {
            subscribe: false,
            all: false,
        }, params, query = null, }) {
            try {
        ...
        async QueryAllowances({ commit, rootGetters, getters }, { options: { subscribe, all } = {
            subscribe: false,
            all: false,
        }, params, query = null, }) {
            try {
