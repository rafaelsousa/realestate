...
} from './module/types/cosmos/distribution/v1beta1/distribution'
import {
...
} from './module/types/cosmos/distribution/v1beta1/genesis'
...
export default {
    ...
    async QueryValidatorOutstandingRewards({ commit, rootGetters, getters }, {
      options: {
        subscribe,
        all,
    ...
    async QueryValidatorCommission({ commit, rootGetters, getters }, {
      options: { subscribe, all } = {
        subscribe: false,
        all: false,
      }, params, query = null,
    ...
    async QueryValidatorSlashes({ commit, rootGetters, getters }, {
      options: { subscribe, all } = {
        subscribe: false,
        all: false,
      }, params, query = null,
    ...
    async QueryDelegationRewards({ commit, rootGetters, getters }, {
      options: { subscribe, all } = {
        subscribe: false,
        all: false,
      }, params, query = null,
    ...
    async QueryDelegationTotalRewards({ commit, rootGetters, getters }, {
      options: {
        subscribe,
        all,
      } = { subscribe: false, all: false }, params, query = null,
    ...
    async QueryDelegatorWithdrawAddress({ commit, rootGetters, getters }, {
      options: {
        subscribe,
        all,
      } = { subscribe: false, all: false }, params, query = null,
    ...
    async QueryCommunityPool({ commit, rootGetters, getters }, {
      options: { subscribe, all } = {
        subscribe: false,
        all: false,
      }, params, query = null,
