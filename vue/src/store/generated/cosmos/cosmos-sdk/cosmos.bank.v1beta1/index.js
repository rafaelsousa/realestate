  ...
  actions: {
    ...
    async QueryBalance(
      ...
      try {
        ...
        while (all && value.pagination && value.pagination.next_key != null) {
          let next_values = (
            await queryClient.queryBalance(key.address, { ...query, 'pagination.key': value.pagination.next_key })
          ).data
    ...
    async QueryAllBalances(
      ...
      try {
        ...
        while (all && value.pagination && value.pagination.next_key != null) {
          let next_values = (
            await queryClient.queryAllBalances(key.address, { ...query, 'pagination.key': value.pagination.next_key })
          ).data
          value = mergeResults(value, next_values)
        }
    ...
    async QueryTotalSupply(
      ...
      try {
        ...
        while (all && value.pagination && value.pagination.next_key != null) {
          let next_values = (
            await queryClient.queryTotalSupply({ ...query, 'pagination.key': value.pagination.next_key })
          ).data
          value = mergeResults(value, next_values)
        }
    ...
    async QueryDenomsMetadata(
      ...
      try {
        ...
        while (all && value.pagination && value.pagination.next_key != null) {
          let next_values = (
            await queryClient.queryDenomsMetadata({ ...query, 'pagination.key': value.pagination.next_key })
          ).data
          value = mergeResults(value, next_values)
        }
