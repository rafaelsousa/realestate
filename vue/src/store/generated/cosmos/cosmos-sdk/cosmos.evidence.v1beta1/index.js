...
export default {
    ...
    actions: {
        ...
        async QueryEvidence({ commit, rootGetters, getters }, { options: { subscribe, all } = {
            subscribe: false,
            all: false,
        }, params, query = null, }) {
            try {
        ...
        async QueryAllEvidence({ commit, rootGetters, getters }, { options: { subscribe, all } = {
            subscribe: false,
            all: false,
        }, params, query = null, }) {
            try {
                ...
                while (all && value.pagination && value.pagination.next_key != null) {
                    let next_values = (await queryClient.queryAllEvidence({
                        ...query,
