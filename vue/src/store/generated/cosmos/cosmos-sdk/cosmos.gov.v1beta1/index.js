...
import { Deposit, DepositParams, Proposal, TallyParams, TallyResult, TextProposal, Vote, VotingParams, WeightedVoteOption, } from './module/types/cosmos/gov/v1beta1/gov';
...
export default {
    ...
    actions: {
        ...
        async QueryProposal({ commit, rootGetters, getters }, { options: { subscribe, all } = {
            subscribe: false,
            all: false,
        }, params, query = null, }) {
            try {
        ...
        async QueryProposals({ commit, rootGetters, getters }, { options: { subscribe, all } = {
            subscribe: false,
            all: false,
        }, params, query = null, }) {
            try {
                ...
                while (all && value.pagination && value.pagination.next_key != null) {
                    let next_values = (await queryClient.queryProposals({
                        ...query,
        ...
        async QueryVotes({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params, query = null, }) {
            try {
                ...
                while (all && value.pagination && value.pagination.next_key != null) {
                    let next_values = (await queryClient.queryVotes(key.proposal_id, {
                        ...query,
                        'pagination.key': value.pagination.next_key,
                    })).data;
                    value = mergeResults(value, next_values);
        ...
        async QueryDeposit({ commit, rootGetters, getters }, { options: { subscribe, all } = {
            subscribe: false,
            all: false,
        }, params, query = null, }) {
            try {
        ...
        async QueryDeposits({ commit, rootGetters, getters }, { options: { subscribe, all } = {
            subscribe: false,
            all: false,
        }, params, query = null, }) {
            try {
                ...
                while (all && value.pagination && value.pagination.next_key != null) {
                    let next_values = (await queryClient.queryDeposits(key.proposal_id, {
                        ...query,
                        'pagination.key': value.pagination.next_key,
                    })).data;
                    value = mergeResults(value, next_values);
        ...
        async QueryTallyResult({ commit, rootGetters, getters }, { options: { subscribe, all } = {
            subscribe: false,
            all: false,
        }, params, query = null, }) {
            try {
