...
import {
  ...
  VotingParams,
  WeightedVoteOption,
} from './module/types/cosmos/gov/v1beta1/gov'
...
export default {
    ...
    async QueryProposal({ commit, rootGetters, getters }, {
    ...
    async QueryProposals({ commit, rootGetters, getters }, {
      options: { subscribe, all } = {
        subscribe: false,
        all: false,
      }, params, query = null,
    ...
    async QueryVote({ commit, rootGetters, getters }, {
    ...
    async QueryVotes({ commit, rootGetters, getters }, {
      options: { subscribe, all } = { subscribe: false, all: false },
      params,
      query = null,
    }) {
    ...
    async QueryDeposit({ commit, rootGetters, getters }, {
      options: { subscribe, all } = {
        subscribe: false,
        all: false,
      }, params, query = null,
    ...
    async QueryDeposits({ commit, rootGetters, getters }, {
      options: { subscribe, all } = {
        subscribe: false,
        all: false,
      }, params, query = null,
    ...
    async QueryTallyResult({ commit, rootGetters, getters }, {
      options: { subscribe, all } = {
        subscribe: false,
        all: false,
      }, params, query = null,
