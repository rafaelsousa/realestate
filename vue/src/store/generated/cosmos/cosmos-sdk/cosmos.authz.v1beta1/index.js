...
import { GenericAuthorization, Grant } from './module/types/cosmos/authz/v1beta1/authz';
import { EventGrant, EventRevoke } from './module/types/cosmos/authz/v1beta1/event';
...
export default {
    ...
    actions: {
        ...
        async QueryGrants({ commit, rootGetters, getters }, { options: { subscribe, all } = {
            subscribe: false,
            all: false,
        }, params, query = null, }) {
            try {
                ...
                while (all && value.pagination && value.pagination.next_key != null) {
                    let next_values = (await queryClient.queryGrants({
                        ...query,
