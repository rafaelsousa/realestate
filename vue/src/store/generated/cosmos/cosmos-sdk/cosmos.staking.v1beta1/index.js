...
import { StakeAuthorization, StakeAuthorization_Validators } from './module/types/cosmos/staking/v1beta1/authz';
import { LastValidatorPower } from './module/types/cosmos/staking/v1beta1/genesis';
import { Commission, CommissionRates, Delegation, DelegationResponse, Description, DVPair, DVPairs, DVVTriplet, DVVTriplets, HistoricalInfo, Params, Pool, Redelegation, RedelegationEntry, RedelegationEntryResponse, RedelegationResponse, UnbondingDelegation, UnbondingDelegationEntry, ValAddresses, Validator, } from './module/types/cosmos/staking/v1beta1/staking';
...
export default {
    ...
    actions: {
        ...
        async QueryValidators({ commit, rootGetters, getters }, { options: { subscribe, all } = {
            subscribe: false,
            all: false,
        }, params, query = null, }) {
            try {
                ...
                while (all && value.pagination && value.pagination.next_key != null) {
                    let next_values = (await queryClient.queryValidators({
                        ...query,
        ...
        async QueryValidator({ commit, rootGetters, getters }, { options: { subscribe, all } = {
            subscribe: false,
            all: false,
        }, params, query = null, }) {
            try {
        ...
        async QueryValidatorDelegations({ commit, rootGetters, getters }, { options: { subscribe, all, } = { subscribe: false, all: false }, params, query = null, }) {
            try {
                ...
                while (all && value.pagination && value.pagination.next_key != null) {
                    let next_values = (await queryClient.queryValidatorDelegations(key.validator_addr, {
                        ...query,
                        'pagination.key': value.pagination.next_key,
                    })).data;
                    value = mergeResults(value, next_values);
        ...
        async QueryValidatorUnbondingDelegations({ commit, rootGetters, getters }, { options: { subscribe, all, } = { subscribe: false, all: false }, params, query = null, }) {
            try {
                ...
                while (all && value.pagination && value.pagination.next_key != null) {
                    let next_values = (await queryClient.queryValidatorUnbondingDelegations(key.validator_addr, {
                        ...query,
                        'pagination.key': value.pagination.next_key,
                    })).data;
                    value = mergeResults(value, next_values);
        ...
        async QueryDelegation({ commit, rootGetters, getters }, { options: { subscribe, all } = {
            subscribe: false,
            all: false,
        }, params, query = null, }) {
            try {
        ...
        async QueryUnbondingDelegation({ commit, rootGetters, getters }, { options: { subscribe, all } = {
            subscribe: false,
            all: false,
        }, params, query = null, }) {
            try {
        ...
        async QueryDelegatorDelegations({ commit, rootGetters, getters }, { options: { subscribe, all, } = { subscribe: false, all: false }, params, query = null, }) {
            try {
                ...
                while (all && value.pagination && value.pagination.next_key != null) {
                    let next_values = (await queryClient.queryDelegatorDelegations(key.delegator_addr, {
                        ...query,
                        'pagination.key': value.pagination.next_key,
                    })).data;
                    value = mergeResults(value, next_values);
        ...
        async QueryDelegatorUnbondingDelegations({ commit, rootGetters, getters }, { options: { subscribe, all, } = { subscribe: false, all: false }, params, query = null, }) {
            try {
                ...
                while (all && value.pagination && value.pagination.next_key != null) {
                    let next_values = (await queryClient.queryDelegatorUnbondingDelegations(key.delegator_addr, {
                        ...query,
                        'pagination.key': value.pagination.next_key,
                    })).data;
                    value = mergeResults(value, next_values);
        ...
        async QueryRedelegations({ commit, rootGetters, getters }, { options: { subscribe, all } = {
            subscribe: false,
            all: false,
        }, params, query = null, }) {
            try {
                ...
                while (all && value.pagination && value.pagination.next_key != null) {
                    let next_values = (await queryClient.queryRedelegations(key.delegator_addr, {
                        ...query,
                        'pagination.key': value.pagination.next_key,
                    })).data;
                    value = mergeResults(value, next_values);
        ...
        async QueryDelegatorValidators({ commit, rootGetters, getters }, { options: { subscribe, all } = {
            subscribe: false,
            all: false,
        }, params, query = null, }) {
            try {
                ...
                while (all && value.pagination && value.pagination.next_key != null) {
                    let next_values = (await queryClient.queryDelegatorValidators(key.delegator_addr, {
                        ...query,
                        'pagination.key': value.pagination.next_key,
                    })).data;
                    value = mergeResults(value, next_values);
        ...
        async QueryDelegatorValidator({ commit, rootGetters, getters }, { options: { subscribe, all } = {
            subscribe: false,
            all: false,
        }, params, query = null, }) {
            try {
        ...
        async QueryHistoricalInfo({ commit, rootGetters, getters }, { options: { subscribe, all } = {
            subscribe: false,
            all: false,
        }, params, query = null, }) {
            try {
        ...
        async QueryParams({ commit, rootGetters, getters }, { options: { subscribe, all } = {
            subscribe: false,
            all: false,
        }, params, query = null, }) {
            try {
