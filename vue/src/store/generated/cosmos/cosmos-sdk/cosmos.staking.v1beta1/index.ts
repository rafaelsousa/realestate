...
import {
  ...
  ValAddresses,
  Validator,
} from './module/types/cosmos/staking/v1beta1/staking'
...
export default {
    ...
    async QueryValidators({ commit, rootGetters, getters }, {
    ...
    async QueryValidator({ commit, rootGetters, getters }, {
      options: { subscribe, all } = {
        subscribe: false,
        all: false,
      }, params, query = null,
    ...
    async QueryValidatorDelegations({ commit, rootGetters, getters }, {
      options: {
        subscribe,
        all,
      } = { subscribe: false, all: false }, params, query = null,
    }) {
      try {
        const key = params ?? {}
        const queryClient = await initQueryClient(rootGetters)
    ...
    async QueryValidatorUnbondingDelegations({ commit, rootGetters, getters }, {
      options: {
        subscribe,
        all,
      } = { subscribe: false, all: false }, params, query = null,
    ...
    async QueryDelegation({ commit, rootGetters, getters }, {
      options: { subscribe, all } = {
        subscribe: false,
        all: false,
      }, params, query = null,
    ...
    async QueryUnbondingDelegation({ commit, rootGetters, getters }, {
      options: { subscribe, all } = {
        subscribe: false,
        all: false,
      }, params, query = null,
    ...
    async QueryDelegatorDelegations({ commit, rootGetters, getters }, {
      options: {
        subscribe,
        all,
      } = { subscribe: false, all: false }, params, query = null,
    ...
    async QueryDelegatorUnbondingDelegations({ commit, rootGetters, getters }, {
      options: {
        subscribe,
        all,
      } = { subscribe: false, all: false }, params, query = null,
    ...
    async QueryRedelegations({ commit, rootGetters, getters }, {
      options: { subscribe, all } = {
        subscribe: false,
        all: false,
      }, params, query = null,
    ...
    async QueryDelegatorValidators({ commit, rootGetters, getters }, {
      options: { subscribe, all } = {
        subscribe: false,
        all: false,
      }, params, query = null,
    ...
    async QueryDelegatorValidator({ commit, rootGetters, getters }, {
      options: { subscribe, all } = {
        subscribe: false,
        all: false,
      }, params, query = null,
    ...
    async QueryHistoricalInfo({ commit, rootGetters, getters }, {
      options: { subscribe, all } = {
        subscribe: false,
        all: false,
      }, params, query = null,
    ...
    async QueryPool({ commit, rootGetters, getters }, {
