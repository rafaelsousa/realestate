...
export default {
  ...
  RafaelsousaRealestateRafaelsousaRealestateBlueprints: load(
    RafaelsousaRealestateRafaelsousaRealestateBlueprints,
    'rafaelsousa.realestate.blueprints',
  ),
  RafaelsousaRealestateRafaelsousaRealestateRealestate: load(
    RafaelsousaRealestateRafaelsousaRealestateRealestate,
    'rafaelsousa.realestate.realestate',
  ),
}
